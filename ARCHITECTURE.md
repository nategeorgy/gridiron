...
Last updated: 2026-08-26 (security — RLS across the whole `public` schema)
...
- **Schema:** fifteen tables — seven of NFL data (`teams`, `players`, `games`,
  ...
  another `source` in `player_rankings`, which was multi-source from day one.
